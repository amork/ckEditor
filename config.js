...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraAllowedContent = '*[data-id, table-parent-id, par-style, start, type, contenteditable, href]; *(*); *{*}; table[cellspacing, cellpadding]; tr; td; tbody; div;h1;h2;h3;h4;h5;h6; a;';
	...
	config.pasteProhibitedAttributes = ['data-id', 'table-parent-id', 'table-id'];
